...
const BOOK: { part: string; color: string; chapters: string[] }[] = [
  ...
  },
  {
    ...
    color: 'var(--nb-blue)',
    chapters: ['linked-list', 'trees', 'advanced-trees', 'sparse-table', 'segment-tree-lazy', 'cycle-detection', 'tree-construction', 'lca', 'dsu-on-tree', 'tree-diameter', 'offline-lca', 'tree-isomorphism', 'persistent-union-find', 'binary-lifting', 'segment-tree-basics', 'tree-path-problems', 'iterative-traversal'],
  },
  {
  ...
  },
  {
    ...
    color: 'var(--nb-pink)',
    chapters: ['math', 'bit-manipulation', 'combinatorics', 'game-theory', 'geometry', 'number-theory', 'probability-dp', 'ternary-search', 'fft', 'sprague-grundy', 'chinese-remainder', 'convex-hull', 'inclusion-exclusion', 'catalan-numbers', 'josephus', 'sieve-variants', 'burnside-lemma', 'gray-code', 'gaussian-gf2', 'lucas-theorem', 'lattice-paths', 'advanced-counting-dp', 'rotating-calipers', 'carry-dp', 'random-walk'],
  },
  {
